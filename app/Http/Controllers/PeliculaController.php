...
class PeliculaController extends Controller
{
    ...
    public function index() {
        $peliculas=Pelicula::with('category')->orderBy('id','desc')->paginate(10);
    ...
    public function store(Request $request) {
        $request->validate([
            ...
            'duracion'=>['required','integer','min:60','max:180'],
            'category_id'=>['required','exists:categories,id']
        ]);
        Pelicula::create($request->all());
        return redirect()->route('peliculas.index')->with('info',"Pelicula creada exitosamente");
    }
    ...
    public function update(Request $request, Pelicula $pelicula) {
        ...
        return redirect()->route('peliculas.index')->with('info',"Pelicula editada exitosamente");
    }
    ...
    {
        $pelicula->delete();
        return redirect()->route('peliculas.index')->with('info',"Pelicula borrada exitosamente");
    }
}
